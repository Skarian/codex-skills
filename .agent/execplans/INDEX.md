...
- EP-2026-02-27__vercel-skills-migration — Full Vercel Skills Migration — Status:ARCHIVED — Created:2026-02-27 — Updated:2026-02-27 — Path:.agent/execplans/archive/EP-2026-02-27__vercel-skills-migration.md — Owner:UNCONFIRMED — Summary:Flattened skills layout and migrated docs/commands to Vercel `npx skills` workflow — Links: — Archived:2026-02-27 — Outcome:Removed curated/experimental/template scaffolding and published Codex/Claude install docs with install locations
